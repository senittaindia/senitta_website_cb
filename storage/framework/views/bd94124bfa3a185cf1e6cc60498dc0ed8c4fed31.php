                ...
                <div class="col-12  col-sm-12 col-lg-3 spaceright-0">
                    <a href="<?php echo e(URL::to('/')); ?>" class="logo">
                        ...
                        <?php if($result['commonContent']['setting'][78]->value=='logo'): ?>
                            <img src="https://3eakmtools.in/senitta_hygiene_bank/resources/assets/images/site_images/1561714614.senitta_logo.png" height="69px" width="171px" alt="Senitta">
                        <?php endif; ?>
                    </a>
                </div>
                 <div class="col-12 col-sm-7 col-md-8 col-lg-6 px-0">      
                    ...
                    <button type="submit" class="btn btn-secondary" style="background-color:#F3ABAF;"><i class="fa fa-search" aria-hidden="true"></i></button>
                    </div>
                    </form>
				</div>
                          ...
                          <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown open">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink02" aria-expanded="false">
                                                                                                                <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=about-us">About Us</a> </li>
                                                                                                                 <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=why-senitta">Why Senitta?</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=healthy-lifestyle">Healthy Lifestyle</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=hygiene-tips">Hygiene Tips</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=makeover-tips">Makeover Tips</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=fashion-and-lifestyle">Fashion and Lifestyle</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=female-facts">Female Facts</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=trending-bytes">Trending Bytes</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=privacy-policy">Privacy Policy</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://3eakmtools.in/senitta_hygiene_bank/page?name=return-policy">Return Policy</a> </li>
