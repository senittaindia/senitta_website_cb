...
//Payments
Route::match(['get','post'],'pay','PaymentController@index');
Route::match(['get','post'],'pay/{amount}','PaymentController@index');
Route::get('pay/response','PaymentController@cancel');
Route::match(['get','post'],'pay/success','PaymentController@success');
...
Route::post('/language/', array(
	...
	*/
	...
	Route::get('/periodtracker', 'ProductsController@periodtracker');
	Route::post('/periodtracker', 'ProductsController@periodtracker');
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	Route::post('login/{social}/callback', 'CustomersController@handleSocialLoginCallback');
