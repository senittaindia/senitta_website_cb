<!-- scripts -->
<script src="{!! asset('resources/views/themeone/js/app.js') !!}"></script>
<script src="{!! asset('resources/views/themeone/js/jquery-ui.js') !!}"></script>

<!-- owl carousel -->
<script src="{!! asset('resources/views/themeone/js/owl.carousel.js') !!}"></script>
...
<script src="{!! asset('resources/views/themeone/js/jquery.star-rating-svg.js') !!}"></script>
<script>
