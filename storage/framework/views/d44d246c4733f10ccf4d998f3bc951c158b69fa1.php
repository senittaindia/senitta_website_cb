...
if($balance_amount>0.00){
  // echo $blcer=intval($balance_amount);
    $hygine_currency1=$price*30/100; 
    $hygine_currency2= intval($hygine_currency1);
    if($balance_amount>=35 && $hygine_currency2< $balance_amount &&$hygine_currency2<35){
        
        $hygine_currency=intval($hygine_currency1);
       
    }
    elseif($balance_amount>=35 && $hygine_currency2< $balance_amount && $hygine_currency2>35){
        
        $hygine_currency=35;
       
    }
     elseif($balance_amount<=35 && $hygine_currency2< $balance_amount){
       $hygine_currency=intval($hygine_currency1);
       echo "goodsss";
    }
     elseif($balance_amount<35 && $hygine_currency2>35){
        $hygine_currency=  $balance_amount;
        echo "goodsss-9";
    }
      elseif($balance_amount>35 && $hygine_currency2>35){
        $hygine_currency=  35;
...
echo $hygine_currency;
$total_price = ($price+$tax_rate+$shipping_price)-$hygine_currency;	
