                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                	<select name="discount_type" class='form-control'>
                                        ...
                                        <option value="hygiene_cashback" <?php if($result['coupon'][0]->discount_type == 'hygiene_cashback'): ?> selected <?php endif; ?>>Hygiene cashback</option>
                                    </select>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('expiry_date',  date('m/d/Y', strtotime($result['coupon'][0]->expiry_date)), array('class'=>'form-control field-validate coupondatepicker', 'id'=>'', 'readonly'=>'readonly')); ?>
