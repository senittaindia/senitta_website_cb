...
<section class="site-content">
     ...
     <div class="group-banners">
        ...
        <div class="col-md-2">
            <!-- <form action="test.php" method="post">
             ...
             <a href="{{ URL::to('/page?name=makeover-tips')}}" style="text-decoration:none;">
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $makeover;?>%"></div>
         ...
         <div class="col-md-2">
             ...
             <a href="{{ URL::to('/page?name=fashion-and-lifestyle')}}" style="text-decoration:none;"><input type="image" src="/images/Fashion-and-Lifestyle.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             <!-- </form> -->
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $fashion_lifestyle;?>%"></div>
         ...
         <div class="col-md-2">
             ...
             <a href="{{ URL::to('/page?name=female-facts')}}" style="text-decoration:none;"><input type="image" src="/images/Female-Facts.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             <!-- </form> -->
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $female_facts;?>%"></div>
         ...
         <div class="col-md-2">
            ...
            <a href="{{ URL::to('/page?name=trending-bytes')}}" style="text-decoration:none;">
  ...
  <div class="animated fadeInUp delay-2s">
        ...
        <img src="/images/Why-Senitta.jpg" class="center2" alt="Senitta">
            ...
            <div class="col-md-6">
                 <a href="{{ URL::to('/page?name=why-senitta')}}">
