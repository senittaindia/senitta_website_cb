                                    ...
                                    <div class="form-inline">
                                        <div class="form-group col-12 col-md-4">
                                            ...
                                            <div class="col-12 col-lg-7 btn-group">
                                                <a href="javascript:void(0);" id="grid" class="btn btn-default active" style="background-color:#F3ABAF;"> <i class="fa fa-th-large" aria-hidden="true"></i> </a>
                                        ...
                                        <article>
                                            ...
                                            <div class="block-panel">
                                                ...
                                                <p style="text-align:center;">
                                                    <?php if(isset($products->review)): ?>
                                                    <?php if(isset($products->review['avg_rate'])): ?>
                                                      
                                                      <?php if($products->review['avg_rate']==0 || $products->review['avg_rate']==""): ?>
                                                      <img src="https://www.senitta.com/images/stars-0.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']>0 && $products->review['avg_rate']<1): ?>
                                                      <img src="https://www.senitta.com/images/stars-01.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']=='1' || $products->review['avg_rate']==1): ?>
                                                      <img src="https://www.senitta.com/images/stars-1.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']>1 && $products->review['avg_rate']<2): ?>
                                                      <img src="https://www.senitta.com/images/stars-11.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']==2): ?>
                                                      <img src="https://www.senitta.com/images/stars-2.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']>2 && $products->review['avg_rate']<3): ?>
                                                      <img src="https://www.senitta.com/images/stars-21.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']==3): ?>
                                                      <img src="https://www.senitta.com/images/stars-3.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']>3 && $products->review['avg_rate']<4): ?>
                                                      <img src="https://www.senitta.com/images/stars-31.png" alt="Senitta">
                                                       <?php elseif($products->review['avg_rate']==4): ?>
                                                      <img src="https://www.senitta.com/images/stars-4.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']>4 && $products->review['avg_rate']<5): ?>
                                                      <img src="https://www.senitta.com/images/stars-41.png" alt="Senitta">
                                                      <?php elseif($products->review['avg_rate']==5): ?>
                                                      <img src="https://www.senitta.com/images/stars-5.png" alt="Senitta">
                                                      <?php endif; ?>
                                                    <?php endif; ?>
                                                    <?php endif; ?>
                                                </p>
                                                <div class="block-inner">
                                                    <div class="price" style="color:#F3ABAF;">
                                            ...
                                            <div class="product-hover">
                                                <div class="icons">
                                                    <!--<div class="icon-liked">
                                                        <span products_id = '<?php echo e($products->products_id); ?>' class="fa <?php if($products->isLiked==1): ?> fa-heart <?php else: ?> fa-heart-o <?php endif; ?> is_liked" style="color:#F3ABAF;"><span class="badge badge-secondary" style="background-color:#F3ABAF;"><?php echo e($products->products_liked); ?></span></span>
                                                    </div> -->     
                                                </div>
                                                <div class="buttons">
                                                    <?php if($products->products_type==0): ?>
                                                        <?php if(!in_array($products->products_id,$result['cartArray'])): ?>
                                                            ...
                                                            <?php elseif($products->products_min_order>1): ?>
                                                             <a class="btn btn-block btn-secondary" href="<?php echo e(URL::to('/product-detail/'.$products->products_slug)); ?>"><?php echo app('translator')->getFromJson('website.View Detail'); ?></a>
                                                            <?php else: ?>
                                                            	<button type="button" class="btn btn-block btn-secondary cart" products_id="<?php echo e($products->products_id); ?>" style="background-color:#F3ABAF;"><?php echo app('translator')->getFromJson('website.Add to Cart'); ?></button>
                                                            <?php endif; ?>
                                                        <?php else: ?>
