...
<div class="content-wrapper"> 
  ...
  <section class="invoice" style="margin: 15px;">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header" style="padding-bottom: 25px; margin-top:0;">
            ...
            <small style="display: inline-block"><?php echo e(trans('labels.OrderedDate')); ?>: <?php echo e(date('d-m-Y', strtotime($data['orders_data'][0]->date_purchased))); ?></small>
        ...
        <div class="col-xs-5">
          ...
          <div class="table-responsive ">
            <table class="table order-table">
              ...
              <?php endif; ?>
               <?php if(!empty($data['orders_data'][0]->hygiene_currency)): ?>
              <tr>
                <th>Hygiene Currency</th>
                <td>-<?php echo e($data['currency'][19]->value); ?><?php echo e($data['orders_data'][0]->hygiene_currency); ?></td>
              </tr>
              <?php endif; ?>
              <tr>
    ...
    <?php echo Form::open(array('url' =>'admin/updateOrder', 'method'=>'post', 'onSubmit'=>'return cancelOrder();', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
     ...
     <?php echo Form::hidden('order_id', $data['orders_data'][0]->order_id, array('class'=>'form-control', 'id'=>'order_id')); ?>

     <?php echo Form::hidden('order_price', $data['orders_data'][0]->order_price, array('class'=>'form-control', 'id'=>'order_price')); ?>

     <?php echo Form::hidden('payment_method', $data['orders_data'][0]->payment_method, array('class'=>'form-control', 'id'=>'payment_method')); ?>
                ...
                <?php $__currentLoopData = $data['orders_status_history']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orders_status_history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif($orders_status_history->orders_status_id==6): ?>
                            <span class="label label-primary">
                            <?php else: ?>
