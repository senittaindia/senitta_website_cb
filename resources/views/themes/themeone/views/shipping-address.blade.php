            ...
            @endif
               ...
               @if(!empty($result['action']) and $result['action']=='update')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="entry_postcode" maxlength="6" minlength="6" pattern="[0-9]{6}" class="form-control field-validate" id="entry_postcode" @if(!empty($result['editAddress'])) value="{{$result['editAddress'][0]->postcode}}" @endif>
