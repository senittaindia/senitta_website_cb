...
<input type="text" class="form-control field-validate" id="firstname" name="firstname" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->firstname}}@endif" required>
...
<input type="text" class="form-control field-validate" id="lastname" name="lastname" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->lastname}}@endif" required>
...
<input type="text" class="form-control field-validate" id="street" name="street" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->street}}@endif" required>
...
<input type="text" class="form-control field-validate" id="city" name="city" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->city}}@endif" required>
...
<input type="text" class="form-control" id="postcode" maxlength="6" minlength="6" pattern="[0-9]{6}" name="postcode" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->postcode}}@endif" required>
...
<input type="text" maxlength="10" minlength="10" pattern="[0-9]{10}" class="form-control" id="delivery_phone" name="delivery_phone" value="@if(count(session('shipping_address'))>0){{session('shipping_address')->delivery_phone}}@endif" required>
...
<div class="form-group col-md-6">
<label for="lastName">@lang('website.Zip/Postal Code')</label>
<input type="text" maxlength="6" minlength="6" pattern="[0-9]{6}" class="form-control same_address"  @if(count(session('billing_address'))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_zip" name="billing_zip" value="@if(count(session('billing_address'))>0){{session('billing_address')->billing_zip}}@endif" required>
<span class="help-block error-content" hidden>@lang('website.Please enter your Zip/Postal Code')</span> 
</div>	

<div class="form-group col-md-6">
<label for="lastName">@lang('website.Phone Number')</label>
<input type="text" maxlength="10" minlength="10" pattern="[0-9]{10}" class="form-control same_address" @if(count(session('billing_address'))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_phone" name="billing_phone" value="@if(count(session('billing_address'))>0){{session('billing_address')->billing_phone}}@endif" required>
<span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span> 
</div>	  
</div>			
...
@if($payment_methods['payment_method']=='ccavenue')

<!--Customisation-->

<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_creditcard" id="{{$payment_methods['payment_method']}}_creditcard">
<label for="{{$payment_methods['payment_method']}}_creditcard">Credit Card</label>
</li>
<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_debit" id="{{$payment_methods['payment_method']}}_debit">
<label for="{{$payment_methods['payment_method']}}_debit">Debit Cards</label>
</li>
<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_net" id="{{$payment_methods['payment_method']}}_net">
<label for="{{$payment_methods['payment_method']}}_net">Net Banking</label>
</li>
<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_mobile" id="{{$payment_methods['payment_method']}}_mobile">
<label for="{{$payment_methods['payment_method']}}_mobile">Mobile Payments</label>
</li>
<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_paytm" id="{{$payment_methods['payment_method']}}_paytm">
<label for="{{$payment_methods['payment_method']}}_paytm">Mobile Wallets</label>
</li>
<!--<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_wallet" id="{{$payment_methods['payment_method']}}_wallet">
<label for="{{$payment_methods['payment_method']}}_wallet">Wallet</label>
</li>-->
<li>
<input onClick="paymentMethods();" type="radio" name="payment_method" class="payment_method" value="{{$payment_methods['payment_method']}}_upi" id="{{$payment_methods['payment_method']}}_upi">
<label for="{{$payment_methods['payment_method']}}_upi">UPI</label>
</li>
@else
<li>
...
<button onclick="ccavenue()" id="ccavenue_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_creditcard_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_debit_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_net_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_mobile_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_paytm_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_wallet_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
<button onclick="ccavenue()" id="ccavenue_upi_button" class="btn btn-dark payment_btns" style="display: none">@lang('website.Order Now')</button>
</div>
</div>
...
<div class="col-sm-8">
<input type="text" maxlength="10" minlength="10" pattern="[0-9]{10}" name="phone_number" class="form-control" placeholder="@lang('website.Phone Number')" id="insta_phone_number" required>
<span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span>
</div>
</div>
...
<tr>
<th>
<span>  @if(!empty($web_setting[82]->value))</br><small style="text-transform:capitalize;">Avail free shpping on orders INR 500 and above.</small>@endif</span></th>
<!--<td align="right">{{$web_setting[19]->value}}{{$shipping_price}}</td>-->
</tr>
<tr>
<th><span>@lang('website.Discount(Coupon)')</span></th>
...
<form name="payment_mehtods" method="post" id="payment_mehtods_submit" enctype="multipart/form-data" action="{{ URL::to('/pay') }}/{{ number_format((float)$total_price+0, 2, '.', '')+0}}">
    <input type="hidden" name="amount" value="{{ number_format((float)$total_price+0, 2, '.', '')+0}}"/>
