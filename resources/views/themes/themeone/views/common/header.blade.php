<header id="header-area" class="header-area" style="background-color:#F05372 !important;">
                            ...
                            <ul class="navbar-nav">
                                ...
                                @if (Auth::guard('customer')->check())
                                    ...
                                    <li class="nav-item"> <a href="{{ URL::to('/profile')}}" class="nav-link -before">@lang('website.Profile')</a> </li>
                                     <li class="nav-item"> <span class="badge badge-secondary" id="wishlist-count" style="background-color:#F3ABAF;">0</span></li>
