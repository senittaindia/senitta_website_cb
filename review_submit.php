...
if($result)
{
  echo "<script type='text/javascript'>alert('Review Submitted..!!');window.location = 'https://www.senitta.com/shop'</script>";
}
else
{
 echo "<script type='text/javascript'>alert('Failed..!!');window.location = 'https://www.senitta.com/shop'</script>";
}
