                ...
                <div class="col-12  col-sm-12 col-lg-3 spaceright-0">
                    <a href="<?php echo e(URL::to('/')); ?>" class="logo">
                        ...
                        <?php if($result['commonContent']['setting'][78]->value=='logo'): ?>
                            <img src="https://www.senitta.com/resources/assets/images/site_images/1561714614.senitta_logo.png" height="69px" width="171px" alt="Senitta">
                        <?php endif; ?>
                    </a>
                </div>
                          ...
                          <ul class="navbar-nav">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">          
                                    ...
                                    <!--<li>                
                                       ...
                                       <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1570623062.Statement.png" alt="Senitta">Home 
                                                                                 </a>                                     </li>  
                                    <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com/orders"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1570623062.Statement.png" alt="Senitta">Account Statements 
                                                                                 </a>                                     </li>
                                                                               
                                                                                 
                                            
                                    <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com/period/" target="_blank"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1577969963.1570623062.Statement.png" alt="Senitta">Period Tracker 
                                                                                 </a>                                     </li>
                                            

                                            
                                    <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com/page?name=hygiene-tips"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1570623203.Fashion-&amp;-Hygiene-Test.png" alt="Senitta">Fashion &amp; Hygiene Tips 
                                                                                 </a>                                     </li>
                                            
                                    <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com/news?category=pr"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1570623228.in-news.png" alt="Senitta">In-News 
                                                                                 </a>                                     </li>
                                            
                                    <li>                
                                        <a class="dropdown-item" href="https://www.senitta.com/page?name=games"><img class="img-fuild" src="https://senitta.com/resources/assets/images/category_icons/1577970034.1570623062.Statement.png" alt="Senitta">Games 
                                                                                 </a>                                     </li>
                                                              </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown open">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink02" aria-expanded="false">
                                                                                                                <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=about-us">About Us</a> </li>
                                                                                                                 <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=why-senitta">Why Senitta?</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=healthy-lifestyle">Healthy Lifestyle</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=hygiene-tips">Hygiene Tips</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=makeover-tips">Makeover Tips</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=fashion-and-lifestyle">Fashion and Lifestyle</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=female-facts">Female Facts</a> </li>
                                                                            <li> <a class="dropdown-item" href="http://www.senitta.com/page?name=trending-bytes">Trending Bytes</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=privacy-policy">Privacy Policy</a> </li>
                                                                            <li> <a class="dropdown-item" href="https://www.senitta.com/page?name=return-policy">Return Policy</a> </li>
                              ...
                              <ul class="dropdown-menu mega-dropdown-menu row" >
                                ...
                                <li class="col-sm-9 pl-4 row">
                                     ...
                                     <!-- <ul class="col-sm-4">
                                      ...
                                      <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="https://www.senitta.com">Home</a></li>
                                      </ul>
                                      <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="https://www.senitta.com/orders">Account Statements</a></li>
                                      </ul>
                                  
                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="https://www.senitta.com/period/">Period Tracker</a></li>
                                      </ul>
                                    <ul class="col-sm-4">
                                    <li class="dropdown-header"><a href="https://www.senitta.com/page?name=hygiene-tips">Fashion &amp; Hygiene Tips</a></li>
                                    </ul>   
                                                                    
                                     <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="https://www.senitta.com/news?category=pr">In-News</a></li>
                                      </ul> 
                                                                    
                                      <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="https://www.senitta.com/page?name=games">Games</a></li>
                                      </ul>        
