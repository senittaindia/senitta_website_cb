...
<tr>
<td style="padding:10px;width:33%"><img src="https://www.senitta.com/<?php echo $review_value->customers_picture; ?>" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value->customers_firstname.' '.$review_value->customers_lastname;?><br>
...
<tr>
<td style="padding:10px;width:33%"><img src="https://www.senitta.com/<?php echo $review_value1->customers_picture; ?>" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value1->customers_firstname.' '.$review_value1->customers_lastname;?><br>
...
<form method="post" action="https://www.senitta.com/review_submit.php" id="feedback">
<div class="rate">
