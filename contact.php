...
$result=$conn->query("INSERT INTO `contact`(`name`,`email`,`phone`,`message`,`date_s`) VALUES('$name','$email','$phone','$msg','$date')");

//$mm = mail($to,$subject,$message,$headers);

if($result)
{
  echo "<script type='text/javascript'>alert('Submitted Succuessfully..!!');window.location = 'https://www.senitta.com/'</script>";
}
else
{
