...
<a href="#" id="dropdownMenuButton" class="dropdown-toggle"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
	<span class="badge badge-secondary" style="background-color:#F3ABAF;"><?php echo e($qunatity); ?></span>
	...
	<span class="block">
		...
		<?php if(count($result['commonContent']['cart'])>0): ?>                        
			<span class="items" style="color:#fff;"><?php echo e(count($result['commonContent']['cart'])); ?>&nbsp;<?php echo app('translator')->getFromJson('website.items'); ?></span>
		<?php else: ?> 
			<span class="items" style="color:#fff;">(0)&nbsp;<?php echo app('translator')->getFromJson('website.item'); ?></span>
		<?php endif; ?> 
	</span>
</a>
	...
	<ul class="shopping-cart-items" >
		...
		<li>
			...
			<div class="item-thumb">
				<a href="javascript:void(0)" class="icon" onClick="delete_cart_product(<?php echo e($cart_data->customers_basket_id); ?>)"><img class="img-fluid" src="<?php echo e(asset('').'resources/views/themeone/images/close.png'); ?>" alt="icon"></a>
				<div class="image">
