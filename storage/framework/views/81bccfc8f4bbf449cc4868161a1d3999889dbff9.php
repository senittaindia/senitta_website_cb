                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                	<select name="discount_type" class='form-control'>
                                        ...
                                        <option value="hygiene_cashback">Hygiene cashback</option>
                                    </select>
                                	<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									<?php echo Form::text('expiry_date',  '', array('class'=>'form-control field-validate coupondatepicker', 'id'=>'', 'readonly'=>'readonly')); ?>
