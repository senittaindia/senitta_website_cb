        ...
        <div class="footer-block">
            ...
            <div class="single-footer">
              ...
              <ul class="links-list pl-0 mb-0">
                ...
                <li> <a href="<?php echo e(URL::to('/page?name=female-facts')); ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Female Facts </a></li>
                <li> <a href="<?php echo e(URL::to('/news?category=pr')); ?>"><i class="fa fa-angle-double-right"></i>News</a></li>
              </ul>
            </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
    	<div class="footer-image col-12 col-md-6">
            <img class="img-fluid" src="<?php echo e(asset('').'/resources/views/themeone/images/payments.png'); ?>" alt="Senitta">
        </div>
...
<!--- loader content --->
 <div class="loader" id="loader">
	<img src="<?php echo e(asset('').'resources/views/themeone/images/loader.gif'); ?>" alt="Senitta">
</div> 
