...
<title><?php echo e($pageTitle); ?> | Hygiene Brand for Women - Dioxin free Pads, Sanitary Napkin Online in India</title>
	<!-- <title><?php echo e($pageTitle); ?> | <?php echo e($result['commonContent']['setting'][18]->value); ?></title>  -->
    <?php endif; ?>
    
    <?php if(!empty($web_setting[86]->value)): ?>
    <link rel="icon" href="<?php echo e(asset('').$web_setting[86]->value); ?>" type="image/png">
  <?php endif; ?>
   ...
   <meta name="description" content="Shop For The Best Sanitary Pads In India For Women And Girls Online. Senitta Sanitary Napkins Are Soft With Thin Wings. Sync With Your Period Cycle."/> 
    ...
    <?php if(!empty(session("theme"))): ?>
        <link href="<?php echo asset('resources/views/themeone/'.session("theme").'.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    <?php else: ?>
        <link href="<?php echo asset('resources/views/themeone/app.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    <?php endif; ?>
    <link href="<?php echo asset('resources/views/themeone/owl.carousel.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    
    <link href="<?php echo asset('resources/views/themeone/jquery-ui.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    <link href="<?php echo asset('resources/views/themeone/font-awesome.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    
    <link href="<?php echo asset('resources/views/themeone/rtl.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    <link href="<?php echo asset('resources/views/themeone/responsive.css'); ?> " media="all" rel="stylesheet" type="text/css"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo asset('resources/views/themeone/responsive.css'); ?>" data-rel-css="" />
