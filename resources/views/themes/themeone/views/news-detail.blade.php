                                ...
                                <div class="blog-post">
                                    <article>
                                       <div class="blog-thumb">
                                            ...
                                            <!--<img class="img-fluid" src="{{asset('').$result['news'][0]->news_image}}" alt="{{$result['news'][0]->news_name}}" style="height:300px">-->
                                            <?php
                     	   ...
                     	   if($_SERVER['REQUEST_URI']=="/news-detail/senitta-debunks-menstrual-hygiene-myths-spreads-dioxin-awareness")
                     	    ...
                     	    ?>
                                        ...
                                        <div class="blog-block">
                                            <h2 style="font-size:20px;"><b>{{$result['news'][0]->news_name}}</b></h2>
