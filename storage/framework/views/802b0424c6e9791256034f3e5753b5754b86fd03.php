  ...
  <div class="login-logo">
  	...
  	<?php if(empty($web_setting[15]->value) or !file_exists(asset('').$web_setting[15]->value)): ?>
        <?php if($web_setting[66]->value=='1' and $web_setting[67]->value=='0'): ?>
      		<img src="https://3eakmtools.in/senitta_hygiene_bank/senitta.png" class="ionic-hide"> 
        	<img src="https://3eakmtools.in/senitta_hygiene_bank/senitta.png" class="android-hide"> 
        <?php elseif($web_setting[66]->value=='1' and $web_setting[67]->value=='1' or $web_setting[66]->value=='0' and $web_setting[67]->value=='1'): ?> 
   			<img src="https://3eakmtools.in/senitta_hygiene_bank/senitta.png" class="website-hide"> 
    	<?php endif; ?>
    <?php else: ?>
