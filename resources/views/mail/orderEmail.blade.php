  ...
  <div style="display: block;"> 
    ...
    <div style=" float: right; width:30%"> 
        ...
        <table style="width: 100%;padding: 38px 0;">
          ...
          <tr>
            <th style="width:50%;padding: 10px 0; border-top: 1px solid #f4f4f4;" align="left">{{ trans('labels.HygieneCurrency') }}:</th>
            <td align="right" style="border-top: 1px solid #f4f4f4;">{{ $ordersData['orders_data'][0]->currency }}{{ $ordersData['orders_data'][0]->hygiene_currency }}</td>
          </tr>
          
         
          <tr>
            <th style="width:50%;padding: 10px 0; border-top: 1px solid #f4f4f4;" align="left">{{ trans('labels.DiscountCoupon') }}:</th>
