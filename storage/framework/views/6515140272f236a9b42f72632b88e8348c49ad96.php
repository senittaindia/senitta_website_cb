  ...
  <div class="login-logo">
  	...
  	<?php if(empty($web_setting[15]->value) or !file_exists(asset('').$web_setting[15]->value)): ?>
        <?php if($web_setting[66]->value=='1' and $web_setting[67]->value=='0'): ?>
      		<img src="https://www.senitta.com/senitta.png" class="ionic-hide" alt="Senitta"> 
        	<img src="https://www.senitta.com/senitta.png" class="android-hide" alt="Senitta"> 
        <?php elseif($web_setting[66]->value=='1' and $web_setting[67]->value=='1' or $web_setting[66]->value=='0' and $web_setting[67]->value=='1'): ?> 
   			<img src="https://www.senitta.com/senitta.png" class="website-hide" alt="Senitta"> 
    	<?php endif; ?>
    <?php else: ?>
    	<img style="width: 60%" src="<?php echo e(asset('').$web_setting[15]->value); ?>" alt="Senitta">
    <?php endif; ?>
    ...
    <?php echo Form::open(array('url' =>'admin/checkLogin', 'method'=>'post', 'class'=>'form-validate')); ?>
      ...
      <div class="form-group has-feedback">
       ...
       <span class="help-block hidden"><?php echo e(trans('labels.textRequiredFieldMessage')); ?></span>
  	  ...
  	  <!--<img src="http://ionicecommerce.com/testcontroller1.php" alt="Senitta">-->
      <div class="row">
