                                    ...
                                    <div class="card-body">
                                        <div class="card-text">
                                            <p>
                                                ...
                                                @elseif($result['orders'][0]->orders_status_id == '4')
                                                ...
                                                <thead>
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                        ...
                                                        <!--<td>{{$result['orders'][0]->currency}}{{$products->final_price+0}}</td>-->
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td valign="middle" align="right">{{$result['orders'][0]->currency}}{{$result['orders'][0]->hygiene_currency}}</td>
                                                    </tr>
                                                    <tr>
                                                        <th><span>Coupon Price
                                                        @if($result['orders'][0]->coupon_amount >0)
