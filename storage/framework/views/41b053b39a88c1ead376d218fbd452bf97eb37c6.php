                        ...
                        <?php endif; ?>
                            ...
                            <?php endif; ?>
                                ...
                                <div class="product-summary">
                                    ...
                                    <h3 class="product-title alpha"><?php echo e($result['detail']['product_data'][0]->products_name); ?></h3>   
                                    ...
                                    <div class="product-info" style="display:-webkit-inline-box;">
                                        <?php if(isset($result['reviews'])): ?>
                                                    <?php if(isset($result['reviews']['avg_rate'])): ?>
                                                      ...
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-1.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']>1 && $result['reviews']['avg_rate']<2): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-11.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']==2): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-2.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']>2 && $result['reviews']['avg_rate']<3): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-21.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']==3): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-3.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']>3 && $result['reviews']['avg_rate']<4): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-31.png')); ?>" alt="Senitta">
                                                       <?php elseif($result['reviews']['avg_rate']==4): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-4.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']>4 && $result['reviews']['avg_rate']<5): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-41.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']==5): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-5.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']==0): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-0.png')); ?>" alt="Senitta">
                                                      <?php elseif($result['reviews']['avg_rate']>0 && $result['reviews']['avg_rate']<1): ?>
                                                      <img src="<?php echo e(URL::to('/resources/views/themeone/images/stars-01.png')); ?>" alt="Senitta">
                                                      <?php endif; ?>
                                         ...
                                         ?>
                                            ...
                                            <div class="form-group Qty" <?php if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date ): ?> style="display: none" <?php endif; ?>>
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text"   name="quantity" value="<?php echo e($min_order_limit); ?>" min="<?php echo e($min_order_limit); ?>" max="<?php echo e($max_order_limit); ?>" class="form-control qty" readonly>											
...
<td style="padding:10px;width:33%"><!-- <img src="{{ URL::to('/<?php echo $review_value->customers_picture; ?>')}}" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value->customers_firstname.' '.$review_value->customers_lastname;?><br> -->
  <img src="<?php echo e(URL::to('/resources/views/themeone/images/default.png')); ?>" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value->customers_firstname.' '.$review_value->customers_lastname;?><br>
...
<tr>
<td style="padding:10px;width:33%"><!-- <img src="{{ URL::to('/<?php echo $review_value1->customers_picture; ?>')}}" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value1->customers_firstname.' '.$review_value1->customers_lastname;?> --><img src="<?php echo e(URL::to('/resources/views/themeone/images/default.png')); ?>" style="height:50px;width:50px;border-radius:50px;" alt="Senitta"><br><?php echo $review_value1->customers_firstname.' '.$review_value1->customers_lastname;?><br>
...
<form method="post" action="<?php echo e(URL::to('/')); ?>" id="feedback">
<div class="rate">
