<!-- scripts -->
<script src="<?php echo asset('resources/views/themeone/js/app.js'); ?>"></script>
<script src="<?php echo asset('resources/views/themeone/js/jquery-ui.js'); ?>"></script>

<!-- owl carousel -->
<script src="<?php echo asset('resources/views/themeone/js/owl.carousel.js'); ?>"></script>
...
<!--<script src="https://www.senitta.com/public/jquery.star-rating-svg.js"></script>-->
<script src="<?php echo asset('resources/views/themeone/js/jquery.star-rating-svg.js'); ?>"></script>
<script>
...
jQuery(document).on('keyup focusout', '.email-validate', function(e){
	...
	jQuery('.qtyplus').click(function(e){
		...
		var currentVal = parseInt(jQuery(this).prev('.qty').val());
            //var max= parseInt(jQuery(this).prev('.qty').attr('max'));

		var maximumVal =  parseInt(jQuery(this).prev('.qty').attr('max'));
	//	alert(maximumVal);
		// If is not undefined
		if (!isNaN(currentVal)) {
			if(maximumVal!=0){				
	...
	jQuery(".qtyminus").click(function(e) {
		...
		// Get the field name
		fieldName = jQuery(this).attr('field');
		var maximumVal =  parseInt(jQuery(this).next('.qty').attr('max'));
		var minimumVal = parseInt(jQuery(this).next('.qty').attr('min')); 
...
jQuery('.slide-toggle').on('click', function(event){
 jQuery('.color-panel').toggleClass('active');
	 ...
	 jQuery( function() {		 
	  ...
	  var minimum = getUrlParameter('min_price') ? parseInt(getUrlParameter('min_price')): 0;
	  var maximum = getUrlParameter('max_price') ? parseInt(getUrlParameter('max_price')) : maximum_price;
	  
	  if(parseInt(getUrlParameter('min_price')) === 0 && parseInt(getUrlParameter('max_price')) ===  maximum_price){
	  	console.log(parseInt(getUrlParameter('min_price')), parseInt(getUrlParameter('max_price')));
	  	...
	  	if(maximum){
	  		...
	  		console.log(jQuery('#max_price').val());
	  	}	
	  	
	  }
	  	
	  	jQuery('#min_price').val(minimum);
	  	jQuery('#max_price').val(maximum);
	  ...
	  jQuery( "#slider-range" ).slider({
		...
		slide: function( event, ui ) {
			...
			jQuery('#min_price_show').val(min_price );
	   ...
	   if(getUrlParameter('min_price') || getUrlParameter('max_price')){
	   localStorage.setItem("min", minimum);
	   localStorage.setItem("max", maximum);
		}else {
...
// new js //
jQuery('.dropdown.open').click(function(){
