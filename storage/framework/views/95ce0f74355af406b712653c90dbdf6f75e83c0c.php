...
<section class="site-content">
  <div class="container">
     <div class="group-banners">
    	...
    	<div class="row" style="margin-top:-2.5%;">
    	 <div class="col-md-4">   
        <img src="https://www.senitta.com/images/Senitta-Banner.png" alt="Senitta" >
        </div>
        <div class="col-md-2">
            <form action="test.php" method="post">
                <input type="hidden" name="makeover" value="1"/>
             <a href="https://www.senitta.com/page?name=makeover-tips" style="text-decoration:none;"><input type="image" src="https://www.senitta.com/images/Makeover-Tips.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             </form>
             <?php echo $makeover;?>%
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $makeover;?>%"></div>
         ...
         <div class="col-md-2">
             ...
             <a href="https://www.senitta.com/page?name=fashion-and-lifestyle" style="text-decoration:none;"><input type="image" src="https://www.senitta.com/images/Fashion-and-Lifestyle.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             </form>
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $fashion_lifestyle;?>%"></div>
         ...
         <div class="col-md-2">
             ...
             <a href="http://www.senitta.com/page?name=female-facts" style="text-decoration:none;"><input type="image" src="https://www.senitta.com/images/Female-Facts.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             </form>
  ...
  <div class="w3-green" style="height:24px;width:<?php echo $female_facts;?>%"></div>
         ...
         <div class="col-md-2">
            ...
            <a href="http://www.senitta.com/page?name=trending-bytes" style="text-decoration:none;"> <input type="image" src="https://www.senitta.com/images/Trending-Bytes.png" class="center1" style="margin-top:20%" alt="Submit"></a>
             </form>
  ...
  <div class="animated fadeInUp delay-2s">
        <div class="row" style="background-color: #f5f5f5;">
            <div class="col-md-6">
        <img src="https://www.senitta.com/images/Why-Senitta.jpg" class="center2" alt="Senitta">
        </div>
       
            <div class="col-md-6">
                 <a href="https://www.senitta.com/page?name=why-senitta"><img src="https://www.senitta.com/images/website_banner_text.jpg" class="center2" alt="Senitta"></a>
        </div>
        </div>
        </div>
        ...
        <div class="row" style="background-color: #fff;margin-left:0px;">
            <div class="col-md-6">
        <a href="https://play.google.com/store/apps/details?id=com.senitta.hygiene"><img src="https://www.senitta.com/images/Play_win_copy3.jpg" class="center2" alt="Senitta"></a>
        </div>
        <div class="col-md-6">
            <img src="https://www.senitta.com/images/Play_win_copy4.jpg" class="center2" alt="Senitta">
            </div>
        </div>
        </div>
        <p>&nbsp;</p>
...
<div id="boxes">
  <div style="top: 199.5px; left: 551.5px; display: none;" id="dialog" class="window">
    ...
    border-radius: 50px">X</a></div>
      <p style="font-size:16px;color:#000;"><img src="https://www.senitta.com/resources/assets/images/site_images/1561714614.senitta_logo.png" alt="Senitta" height="69px" width="171px"><br><br>Welcome to Senitta Hygiene Bank (SHB). Please provide below information to open your Hygiene bank account.</p>
    <div id="lorem">
      <p> 
