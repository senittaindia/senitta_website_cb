                                    ...
                                    <tr>
                                        ...
                                        <td>                                        
                                            ...
                                            <?php else: ?>
                                             	...
                                             	<?php elseif($orders->orders_status_id == '6'): ?>
                                             		<span class="badge badge-primary"><?php echo e($orders->orders_status); ?></span>
                                             	<?php elseif($orders->orders_status_id == '1'): ?> 
                                                <span class="badge badge-warning"><?php echo e($orders->orders_status); ?></span> 
                                                &nbsp;&nbsp;/&nbsp;&nbsp;
                                         
                                                <form action="<?php echo e(URL::to('/updatestatus')); ?>" method="post" onSubmit="return cancelOrder();" style="display: inline-block" id="cancelForm-<?php echo e($orders->orders_id); ?>">
                                                <input type="hidden" name="orders_id" value="<?php echo e($orders->orders_id); ?>">
                                                <input type="hidden" name="orders_status_id" value="4">
                                                <input type="hidden" name="comments" value="" id="commentc-<?php echo e($orders->orders_id); ?>">
                                                <button type="button" class="badge badge-danger" style="text-transform:capitalize;cursor:pointer" onclick="cancel(<?php echo e($orders->orders_id); ?>);"><?php echo app('translator')->getFromJson('website.cancel order'); ?> </button>
                                                </form>
