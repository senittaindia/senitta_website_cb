        ...
        <div class="row align-items-center">
           ...
           <div class="col-12 col-sm-7 col-md-8 col-lg-6 px-0">      
            <form class="form-inline" action="{{ URL::to('/shop')}}" method="get">
                ...
                <input type="search" name="search" placeholder="@lang('website.Search entire store here')..." value="{{ app('request')->input('search') }}" aria-label="Search" style="width:100%;">
        ...
        <ul class="top-right-list">        
                        ...
                        <li class="wishlist-header">
                            <a href="{{ URL::to('/wishlist')}}">
                                <span class="badge badge-secondary" id="wishlist-count" style="background-color:#F3ABAF;">{{$result['commonContent']['totalWishList']}}</span>
                ...
                <div class="collapse navbar-collapse" id="navbar_collapse_1">
                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown dropdown-main">
                        ...
                        <a href="" class="nav-link " id="navbarDropdownMenuLink00" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:#F3ABAF;"> <i class="fa fa-align-right" aria-hidden="true"></i>@lang('website.All Categories')  <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                              ...
                              <!--<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">          
                                @foreach($result['commonContent']['categories'] as $categories_data)            
                                    <li>                
                                        <a class="dropdown-item" href="{{ URL::to('/shop')}}?category={{$categories_data->slug}}"><img class="img-fuild" src="{{asset('').$categories_data->icon}}" alt="Senitta">{{$categories_data->name}} 
                                        ...
                                        <ul class="dropdown-menu dropdown-submenu">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="{{ URL::to('/shop')}}?category={{$sub_categories_data->sub_slug}}"><img class="img-fuild" src="{{asset('').$sub_categories_data->sub_icon}}" alt="Senitta">{{$sub_categories_data->sub_name}}</a></li>
                                            @endforeach 
                                        </ul>
                                    @endif
                                    </li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink00">          
                                    ...
                                    <!--<li>                
                                        ...
                                        <li>                
                                            <a class="dropdown-item" href="{{ URL::to('/')}}"><img class="img-fuild" src="/resources/assets/images/category_icons/1570623062.Statement.png" alt="Senitta">Home 
                                            </a>                                     </li>  
                                            <li>                
                                                <a class="dropdown-item" href="{{ URL::to('/orders')}}"><img class="img-fuild" src="/resources/assets/images/category_icons/1570623062.Statement.png" alt="Senitta">Account Statements 
                                                </a>                                     </li>



                                                <li>                
                                                    <a class="dropdown-item" href="{{ URL::to('/period')}}" target="_blank"><img class="img-fuild" src="/resources/assets/images/category_icons/1577969963.1570623062.Statement.png" alt="Senitta">Period Tracker 
                                                    </a>                                     </li>



                                                    <li>                
                                                        <a class="dropdown-item" href="{{ URL::to('/page?name=hygiene-tips')}}"><img class="img-fuild" src="/resources/assets/images/category_icons/1570623203.Fashion-&amp;-Hygiene-Test.png" alt="Senitta">Fashion &amp; Hygiene Tips 
                                                        </a>                                     </li>

                                                        <li>                
                                                            <a class="dropdown-item" href="{{ URL::to('/news?category=pr')}}"><img class="img-fuild" src="/resources/assets/images/category_icons/1570623228.in-news.png" alt="Senitta">In-News 
                                                            </a>                                     </li>

                                                            <li>                
                                                                <a class="dropdown-item" href="{{ URL::to('/page?name=games')}}"><img class="img-fuild" src="/resources/assets/images/category_icons/1577970034.1570623062.Statement.png" alt="Senitta">Games 
                                                                </a>                                     </li>
                                                            </ul>
                                                        </li>
                            ...
                            <li class="nav-item dropdown open">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink02" aria-expanded="false">
                                    <li> <a class="dropdown-item" href="{{ URL::to('/page?name=about-us')}}">About Us</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=why-senitta')}}">Why Senitta?</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=healthy-lifestyle')}}">Healthy Lifestyle</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=hygiene-tips')}}">Hygiene Tips</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=makeover-tips')}}">Makeover Tips</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=fashion-and-lifestyle')}}">Fashion and Lifestyle</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=female-facts')}}">Female Facts</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=trending-bytes')}}">Trending Bytes</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=privacy-policy')}}">Privacy Policy</a> </li>
                                    <li> <a class="dropdown-item" href="{{ URL::to('page?name=return-policy')}}">Return Policy</a> </li>
                            ...
                            <li class="nav-item last"><a class="nav-link" ><span style="background-color:#F3ABAF;">@lang('website.hotline')</span>({{$result['commonContent']['setting'][11]->value}})</a></li>
                        </ul>
                    </div>
                </nav>
...
<!--
                        ...
                        <ul class="dropdown-menu mega-dropdown-menu row" >
                            ...
                            <li class="col-sm-9 pl-4 row">
                                    ...
                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('/')}}">Home</a></li>
                                    </ul>
                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('/orders')}}">Account Statements</a></li>
                                    </ul>

                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('/period')}}">Period Tracker</a></li>
                                    </ul>
                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('/page?name=hygiene-tips')}}">Fashion &amp; Hygiene Tips</a></li>
                                    </ul>   

                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('/news?category=pr')}}">In-News</a></li>
                                    </ul> 

                                    <ul class="col-sm-4">
                                        <li class="dropdown-header"><a href="{{ URL::to('page?name=games')}}">Games</a></li>
                                    </ul>        
