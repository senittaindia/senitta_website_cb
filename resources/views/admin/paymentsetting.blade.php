                         ...
                         <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    ...
                                    <label class=" control-label">
                                          <input type="checkbox" name="ccavenue_active" id="ccavenue_active" value="1" class="checkboxess " @if($result['shipping_methods'][0]->ccavenue_active==1) checked @endif > &nbsp;{{ trans('CCAvenue') }}
                                    </label>
							...
							<!-- / Added By Arpit -->
							<h4>{{ trans('labels.CCAvenue') }}</h4>
                            <hr>
                            {!! Form::hidden('ccavenue_name',  $result['shipping_methods'][0]->ccavenue_name , array('class'=>'form-control', 'id'=>'ccavenue_name')) !!}
                                @foreach($result['ccavenue_description'] as $description_data)
                                    <div class="form-group">
                                      <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CCAvenueName') }} ({{ $description_data['language_name'] }})</label>
                                      <div class="col-sm-10 col-md-4">
                                        <input type="text" name="ccavenue_name_<?=$description_data['languages_id']?>" class="form-control stripe_active @if($result["shipping_methods"][0]->ccavenue_active==1) field-validate @endif" value="{{$result['shipping_methods'][0]->ccavenue_name}}">
                                      <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.CCAvenueName') }} ({{ $description_data['language_name'] }}).</span>          
                                        <span class="help-block hidden">{{ trans('labels.textRequiredFieldMessage') }}</span>
                                      </div>
                                    </div>
                              	@endforeach
                            <div class="form-group">
								<label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CCAvenueMerchantId') }}</label>
								<div class="col-sm-10 col-md-4">
									<input type="text" name="ccavenue_merchant_id" id="ccavenue_merchant_id" value="{{$result['shipping_methods'][0]->ccavenue_merchant_id}}" class="form-control ccavenue_active @if($result["shipping_methods"][0]->ccavenue_active==1) field-validate @endif">
                                    <!--<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.MerchantIdText') }}</span>-->
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Enter CCAvenue payment Merchant ID.</span>
								</div>
							</div>	
							<div class="form-group">
								<!--<label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CCAvenueAccessCode') }} </label>-->
								<label for="name" class="col-sm-2 col-md-3 control-label">CCAvenue AccessCode </label>
								<div class="col-sm-10 col-md-4">
                               		 <input type="text" name="ccavenue_access_code" id="ccavenue_access_code" value="{{$result['shipping_methods'][0]->ccavenue_access_code}}" class="form-control ccavenue_active @if($result["shipping_methods"][0]->ccavenue_active==1) field-validate @endif">
                                    <!--<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.CCAvenueAccessCodeText') }}</span>-->
                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">Enter CCAvenue Access Code</span>
								</div>
							</div>
							<div class="form-group">
								<!--<label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.CCAvenueWorkingKey') }} </label>-->
								<label for="name" class="col-sm-2 col-md-3 control-label">CCAvenue Working Key </label>
								<div class="col-sm-10 col-md-4">
                               		 <input type="text" name="ccavenue_working_key" id="ccavenue_working_key" value="{{$result['shipping_methods'][0]->ccavenue_working_key}}" class="form-control ccavenue_active @if($result["shipping_methods"][0]->ccavenue_active==1) field-validate @endif">
                                    <!--<span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">{{ trans('labels.CCAvenueWorkingKeyText') }}</span>-->
