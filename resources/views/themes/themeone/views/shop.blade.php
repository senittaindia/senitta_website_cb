                                    ...
                                    <div class="product">
                                        <article>
                                            <div class="thumb">       
                                                ...
                                                <img class="img-fluid" src="{{asset('').$products->products_image}}" alt="{{$products->products_name}}">
                                            ...
                                            <div class="block-panel">
                                                ...
                                                <p style="text-align:center;">
                                                    @if(isset($products->review))
                                                    @if(isset($products->review['avg_rate']))
                                                      
                                                      @if($products->review['avg_rate']==0 || $products->review['avg_rate']=="")
                                                      <img src="{{ URL::to('/images/stars-0.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']>0 && $products->review['avg_rate']<1)
                                                      <img src="{{ URL::to('/images/stars-01.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']=='1' || $products->review['avg_rate']==1)
                                                      <img src="{{ URL::to('/images/stars-1.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']>1 && $products->review['avg_rate']<2)
                                                      <img src="{{ URL::to('/images/stars-11.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']==2)
                                                      <img src="{{ URL::to('/images/stars-2.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']>2 && $products->review['avg_rate']<3)
                                                      <img src="{{ URL::to('/images/stars-21.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']==3)
                                                      <img src="{{ URL::to('/images/stars-3.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']>3 && $products->review['avg_rate']<4)
                                                      <img src="{{ URL::to('/images/stars-31.png')}}" alt="Senitta">
                                                       @elseif($products->review['avg_rate']==4)
                                                      <img src="{{ URL::to('/images/stars-4.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']>4 && $products->review['avg_rate']<5)
                                                      <img src="{{ URL::to('/images/stars-41.png')}}" alt="Senitta">
                                                      @elseif($products->review['avg_rate']==5)
                                            ...
                                            <div class="product-hover">
                                                <div class="icons">
                                                    <!--<div class="icon-liked">
                                                        <span products_id = '{{$products->products_id}}' class="fa @if($products->isLiked==1) fa-heart @else fa-heart-o @endif is_liked" style="color:#F3ABAF;"><span class="badge badge-secondary" style="background-color:#F3ABAF;">{{$products->products_liked}}</span></span>
                                                    </div> -->     
                                                </div>
                                                <div class="buttons">
                                                    @if($products->products_type==0)
                                                        @if(!in_array($products->products_id,$result['cartArray']))
                                                            ...
                                                            @elseif($products->products_min_order>1)
                                                             <a class="btn btn-block btn-secondary" href="{{ URL::to('/product-detail/'.$products->products_slug)}}">@lang('website.View Detail')</a>
                                                            @else
                                                            	<button type="button" class="btn btn-block btn-secondary cart" products_id="{{$products->products_id}}" style="background-color:#F3ABAF;">@lang('website.Add to Cart')</button>
                                                            @endif
                                                        @else
