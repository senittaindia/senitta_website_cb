			...
			<div class="col-12 col-md-6 col-lg-7 new-customers">
				...
				<form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/signupProcess')}}" method="post">
                	...
                	<div class="form-group row justify-content-center">
                        ...
                        <div class="uploader">
                            ...
                            <div class="upload-picture">
                                ...
                                <img class="upload-choose-icon" src="{{asset('').'resources/assets/images/default.png'}}" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" name="firstName" id="firstName" class="form-control field-validate" value="{{ old('firstName') }}" required>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" name="lastName" id="lastName" class="form-control field-validate"  value="{{ old('lastName') }}" required>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="email" name="email" id="email" class="form-control email-validate" value="{{ old('email') }}" required>
