...
<a href="#" id="dropdownMenuButton" class="dropdown-toggle"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
	<span class="badge badge-secondary" style="background-color:#F3ABAF;">{{ $qunatity }}</span>
	<i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
	<span class="block">
		<span class="title">@lang('website.My Cart')</span>                    
		@if(count($result['commonContent']['cart'])>0)                        
			<span class="items" style="color:#fff;">{{ count($result['commonContent']['cart']) }}&nbsp;@lang('website.items')</span>
		@else 
			<span class="items" style="color:#fff;">(0)&nbsp;@lang('website.item')</span>
		@endif 
	</span>
</a>
	...
	<ul class="shopping-cart-items" >
		...
		<li>
			...
			<div class="item-thumb">
				<a href="javascript:void(0)" class="icon" onClick="delete_cart_product({{$cart_data->customers_basket_id}})"><img class="img-fluid" src="{{asset('').'resources/views/themeone/images/close.png'}}" alt="icon"></a>
				<div class="image">
