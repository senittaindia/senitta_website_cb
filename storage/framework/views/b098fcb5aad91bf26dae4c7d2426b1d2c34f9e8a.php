      ...
      <div class="col-12 col-md-6 col-lg-5">
        <div class="footer-block">
            ...
            <div class="single-footer">
              ...
              <ul class="links-list pl-0 mb-0">
              <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=about-us"><i class="fa fa-angle-double-right" aria-hidden="true"></i>About Us</a> </li>
              <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/contact-us"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Contact</a> </li>
              <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=healthy-lifestyle"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Healthy Lifestyle</a> </li>
            <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=hygiene-tips"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Hygiene Tips</a> </li>
            <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=makeover-tips"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Makeover Tips</a> </li>
            <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=privacy-policy"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Privacy Policy</a> </li>
            <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=return-policy"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Return Policy</a> </li>
            ...
            <div class="single-footer">
              <h5>Join Senitta</h5>
              <ul class="links-list pl-0 mb-0">
                 <li> <a href="https://3eakmtools.in/senitta_hygiene_bank/page?name=why-senitta"><i class="fa fa-angle-double-right" aria-hidden="true"></i>Why Senitta?</a> </li>          
                <li> <a href=""><i class="fa fa-angle-double-right" aria-hidden="true"></i>Career</a> </li>
                <li> <a href="https://3eakmtools.in/senitta_portal/"><i class="fa fa-angle-double-right"></i>Employee Login </a></li>
              </ul>
            </div>
        </div>
      </div>
  ...
  <div class="container">
    <div class="row">
        ...
        <div class="footer-info col-12 col-md-6">
            <p> &copy; 2019 <a href="https://3eakmtools.in/senitta_hygiene_bank/" style="text-decoration:none;">Senitta Hygeine Bank.</a> Project powered by <a href="https://www.3ea.in/" style="text-decoration:none;">3EA</a> </p>
        </div>
