...
<div class="content-wrapper"> 
  ...
  <section class="invoice" style="margin: 15px;">
        ...
        <div class="col-xs-5">
          ...
          <div class="table-responsive ">
            <table class="table order-table">
              ...
              @endif
               @if(!empty($data['orders_data'][0]->hygiene_currency))
              <tr>
                <th>Hygiene Currency</th>
                <td>-{{ $data['currency'][19]->value }}{{ $data['orders_data'][0]->hygiene_currency }}</td>
              </tr>
              @endif
              <tr>
    ...
    {!! Form::open(array('url' =>'admin/updateOrder', 'method'=>'post', 'onSubmit'=>'return cancelOrder();', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
     ...
     {!! Form::hidden('order_id', $data['orders_data'][0]->order_id, array('class'=>'form-control', 'id'=>'order_id'))!!}
     {!! Form::hidden('order_price', $data['orders_data'][0]->order_price, array('class'=>'form-control', 'id'=>'order_price'))!!}
     {!! Form::hidden('payment_method', $data['orders_data'][0]->payment_method, array('class'=>'form-control', 'id'=>'payment_method'))!!}
                ...
                @foreach( $data['orders_status_history'] as $orders_status_history)
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($orders_status_history->orders_status_id==6)
                            <span class="label label-primary">
                            @else
